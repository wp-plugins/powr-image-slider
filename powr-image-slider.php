<?php
    /**
     * @package POWr Image Slider
     * @version 1.4.004
     */
    /*
    Plugin Name: POWr Image Slider
    Plugin URI: http://www.powr.io
    Description: A beautiful, responsive slider for images and photos!  Drop the widget anywhere in your theme. Or use the POWr icon in your WP text editor to add to a page or post. Edit on your live page by clicking the settings icon. More plugins and tutorials at POWr.io.
    Author: POWr.io
    Version: 1.4.004
    ...
    */
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////Create Image Slider widget/////////////////////////////////
    class Powr_Image_Slider extends WP_Widget{
      //Create the widget
      public function __construct(){
        parent::__construct( 'powr_image_slider',
                             __( 'POWr Image Slider' ),
                             array( 'description' => __( 'Image Slider by POWr.io') )
        );
      }
      //This prints the div
      public function widget( $args, $instance ){
        ...
        ?>
        <div class='widget powr-image-slider' label='<?php echo $label; ?>'></div>
        <?php
      }
      ...
      public function form( $instance ){
        ?>
        <p>
          No need to edit here - just click the gears icon on your Image Slider.
        </p>
        <p>
    ...
    function register_powr_image_slider() {
      register_widget( 'Powr_Image_Slider' );
    }
    //Use widgets_init action hook to execute custom function
    add_action( 'widgets_init', 'register_powr_image_slider' );
    //Create short codes for adding plugins anywhere:
    function powr_image_slider_shortcode( $atts ){
      if(isset($atts['label'])){
        $label = $atts['label'];
      }else{
        $label = '';
      }
      return "<div class='powr-image-slider' label='$label'></div>";
    }
    add_shortcode( 'powr-image-slider', 'powr_image_slider_shortcode' );
